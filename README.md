# rime_kaomoji_dict
## 项目说明
基于Fork来的项目用Trae跑的，是一个专门标上注音的算是给万象用的kaomoji词库
万象工具箱面对颜文字刷注音是手无缚鸡之力呀
因此就搞了这个，Trae用GPT 5.4跑的，大体检查过一遍
感觉可能有点用就发出来了
就这样吧，用法请看
[万象输入方案自定义词库](https://amzxyz.github.io/doc/dicts/)



下面就是原本的东西了，数据来源还是标上吧
